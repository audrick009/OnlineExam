...
public function getJobEssay($app_id) {
    ...
    $this -> db -> from('jobs j');
    $this -> db -> join('applicantappliedjob aj', 'aj.job_id = j.job_id');
    $this -> db -> join('applicantessay es', 'es.essay_id = aj.essay_id');
    $this -> db -> join('questionbank qb', 'qb.question_id = es.question_id');
